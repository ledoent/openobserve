...
<template>
  ...
  >
    ...
    <div
      ...
      role="button"
      tabindex="0"
      :aria-label="`Group ${row.group_name}`"
    >
      <div class="mobile-group-card__row">
        <q-icon
          name="group"
          size="18px"
          class="mobile-group-card__icon"
        />
        <span class="mobile-group-card__title" :title="row.group_name">
          {{ row.group_name }}
        </span>
        <q-btn
          :icon="moreIcon"
