...
<template>
  <div class="full-width q-mx-lg q-pt-xs">
    ...
    <!-- ═══════════════════════════════════════════════════════════════════ -->
      ...
      <div class="alert-v3-left" style="flex: 6.5; min-height: 0; display: flex; flex-direction: column; gap: 8px;">
      ...
      <div class="alert-v3-right tw:flex tw:flex-col tw:gap-2" style="flex: 3.5; min-height: 0;">
        <!-- Preview Card -->
